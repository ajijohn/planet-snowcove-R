---
title: "SE Bars Notebook - Tuoloumne EXT"
...
rastlist <- list.files(path = "data/TUOLBASEEXT/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/TUOLBASEEXT/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_tuoloumne-ext.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
