---
title: "SE Bars Notebook- Swiss BASE with Slope aspect and North Redo"
...
rastlist <- list.files(path = "data/SLASNORNORMBASEREDOCH/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
ploch <- data.frame()
...
write_csv(df_swiss,file='./data/SLASNORNORMBASEREDOCH/processed-data.csv')
...
print(pch)
ggsave("figs/all_scenes_ch-BASEslopeaspectnorthredo.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
```{r }
library(tidyverse)
plotch_longer_df <- read_csv(file='./data/SLASNORNORMBASEREDOCH/processed-data.csv')
...
print(pch)
ggsave("figs/all_scenes_ch-base-slopeaspectnorthnessredo.png",dpi=300, dev='png',  height=8, width=10,units="in")
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_OA.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_FA.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_DENSE.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_MEDIUM.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_SPARSE.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_UC.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_CE.csv')
```
...
write_csv(df_gunni,file='./data/SLASNORNORMBASEREDOCH/processed-data_ch_OPEN.csv')
```
