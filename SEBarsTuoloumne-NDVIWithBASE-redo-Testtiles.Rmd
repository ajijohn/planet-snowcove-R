---
title: "SE Bars Notebook - Tuoloumne Test tiles NDVI ith BASE"
...
rastlist <- list.files(path = "data/TUOLBASENDVIREDO/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/TUOLBASENDVIREDO/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_tuoloumne-testtiles-ndviplusbase.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
