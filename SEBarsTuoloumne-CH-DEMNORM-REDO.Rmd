---
title: "SE Bars Notebook - DEMNORMPLUSBASE Swiss redo "
...
library(raster)
library(tidyverse)
aso_tuol <- raster('data/EUCHDB20170517_SUPERsnow_depth_3m_binary_wgs84_3m.tif')
...
rastlist <- list.files(path = "data/CHDEMNORMBASEREDO/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/CHDEMNORMBASEREDO/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_demnormplusbaseredo.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
write_csv(df_gunni,file='./data/CHDEMNORMBASEREDO/processed-data_ch_OA.csv')
```
...
write_csv(df_gunni,file='./data/CHDEMNORMBASEREDO/processed-data_ch_FA.csv')
```
...
write_csv(df_gunni,file='./data/CHDEMNORMBASEREDO/processed-data_ch_DENSE.csv')
```
...
write_csv(df_gunni,file='./data/CHDEMNORMBASEREDO/processed-data_ch_MEDIUM.csv')
```
...
write_csv(df_gunni,file='./data/CHDEMNORMBASEREDO/processed-data_ch_SPARSE.csv')
```
