---
title: "SE Bars Notebook - Tuoloumne EXT SRTM Swiss "
...
rastlist <- list.files(path = "data/CHDEMPLUSSRTMEXT/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/CHDEMPLUSSRTMEXT/processed-data.csv')
