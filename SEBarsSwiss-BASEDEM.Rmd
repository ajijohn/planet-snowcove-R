---
title: "SE Bars Notebook- Swiss BASE with DEM"
...
rastlist <- list.files(path = "data/CHBASEDEM/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
ploch <- data.frame()
...
write_csv(df_swiss,file='./data/CHBASEDEM/processed-data.csv')
...
print(pch)
ggsave("figs/all_scenes_ch-BASEDEM.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
