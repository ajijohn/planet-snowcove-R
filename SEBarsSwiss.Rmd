...
write_csv(df_swiss,file='./data/DEMplusCHPredictions/processed-data.csv')
...
```{r }
library(tidyverse)
plotch_longer_df <- read_csv(file='./data/DEMplusCHPredictions/processed-data.csv')
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_OA.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_FA.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_DENSE.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_MEDIUM.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_SPARSE.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_UC.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_CE.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCHPredictions/processed-data_ch_OPEN.csv')
```
