---
title: "SE Bars Notebook - Tuoloumne EXT CODEMPLU Swiss "
...
rastlist <- list.files(path = "data/CODEMPLUSSANJOACH/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/CODEMPLUSSANJOACH/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_codemplus-ext-ch.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
