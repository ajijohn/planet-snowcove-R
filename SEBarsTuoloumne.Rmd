---
title: "SE Bars Notebook - Tuoloumne"
...
rastlist <- list.files(path = "data/DEMplusTOUPredictions/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/DEMplusTOUPredictions/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_tuoloumne.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
