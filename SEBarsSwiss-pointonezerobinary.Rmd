...
library(raster)
library(tidyverse)
aso_ch <- raster('data/EUCHDB20170320_SUPERsnow_depth_4326atpoint1_binary.tiff')
...
write_csv(df_swiss,file='./data/DEMplusCHPredictions/processed-atpoint1_binary.csv')
...
print(pch)
ggsave("figs/all_scenes_chpointonezerobinary.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
```{r }
library(tidyverse)
plotch_longer_df <- read_csv(file='./data/DEMplusCHPredictions/processed-atpoint1_binary.csv')
