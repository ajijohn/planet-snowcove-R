---
title: "SE Bars Notebook- Swiss BASE with NDVI - REDO"
...
rastlist <- list.files(path = "data/CHBASENDVIREDO/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
ploch <- data.frame()
...
write_csv(df_swiss,file='./data/CHBASENDVIREDO/processed-data.csv')
...
print(pch)
ggsave("figs/all_scenes_ch-BASEndviredo.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
print(pch)
ggsave("figs/all_scenes_ch-base-ndvi-redo.png",dpi=300, dev='png',  height=8, width=10,units="in")
...
write_csv(df_gunni,file='./data/CHBASENDVIREDO/processed-data_ch_OA.csv')
```
...
write_csv(df_gunni,file='./data/CHBASENDVIREDO/processed-data_ch_FA.csv')
```
...
write_csv(df_gunni,file='./data/CHBASENDVIREDO/processed-data_ch_DENSE.csv')
```
...
write_csv(df_gunni,file='./data/CHBASENDVIREDO/processed-data_ch_MEDIUM.csv')
```
...
write_csv(df_gunni,file='./data/CHBASENDVIREDO/processed-data_ch_SPARSE.csv')
```
