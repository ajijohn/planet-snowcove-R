---
title: "R visual Notebook - Whole scene but one final - good but with forest and edge"
...
aoi_manu <- extent(c(-107.0562   , -107.051  ,39.03749  , 39.04471  ))
```
...
```{r , echo=FALSE}
raster::area(projectRaster(planet_large_study_area, crs = "+init=epsg:32631"))
...
theme(panel.background = element_rect(colour = "black", fill="white"),legend.position = "none", axis.title.x=element_blank(),
        ...
        axis.ticks.y=element_blank()) +  labs(caption = "BASE with CHM")
```
```{r , echo=FALSE}
...
theme(panel.background = element_rect(colour = "black", fill="white"),legend.position = "none", axis.title.x=element_blank(),
        ...
        axis.ticks.x=element_blank(),axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) +  labs(caption = "BASE with DEM")
```
...
theme(panel.background = element_rect(colour = "black", fill="white"),legend.position = "none", axis.title.x=element_blank(),
        ...
        axis.ticks.x=element_blank(),axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) +  labs(caption = "BASE with NDVI")
```
```{r , echo=FALSE}
...
theme(panel.background = element_rect(colour = "black", fill="white"),legend.position = "none", axis.title.x=element_blank(),
        ...
        axis.ticks.x=element_blank(),axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) +  labs(caption = "BASE w/ Slope+Aspect+Northness")
```
...
base_co <- gplot(pred_study_base_co) + 
  ...
  theme(text = element_text(size=12) ,panel.background = element_rect(colour = "black", fill="white"),legend.position = "none", axis.title.x=element_blank(),
        ...
        axis.ticks.x=element_blank(),axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank())  +  labs(caption = "BASE")
```
...
base_aso_imagery <- gplot(aso_study_area) + 
  ...
  theme(text = element_text(size=12) ,panel.background = element_rect(colour = "black", fill="white"),legend.position = "none", axis.title.x=element_blank(),
        ...
        axis.ticks.x=element_blank(),axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) +  labs(caption = "ASO LIDAR SCA")
```
...
ggsave("figs/main_figure_co_models_scene-subset-good-comparison-forest-edge.png",dpi=300, dev='png',  height=12, width=10,units="in")
```