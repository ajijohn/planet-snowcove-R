...
coord_sf(crs = 4326)+
theme(text = element_text(size=16) ,panel.background = element_rect(colour = "black", fill="white"),legend.position = "none",
       axis.text.x = element_text(angle = 45, hjust = 1)) +
ggspatial::annotation_scale(location = "bl") +
    ggspatial::annotation_north_arrow(location = "br", which_north = "true", height = unit(1.5, "cm"),
      style = ggspatial::north_arrow_fancy_orienteering) +
  labs(x='',  y='', title='Planet RGB') 

baseplanet_co_noticks <-  RStoolbox::ggRGB(planet_large_study_area)+
coord_sf(crs = 4326)+
...
HEFG
"
 baseplanet_co_noticks + base_co +basedemplus_co+ basechm_co +
   basendvi_co + baseslopspnorth_co + basedemco + base_aso_imagery+
  plot_layout(design = layout) +
  plot_annotation(tag_levels = 'a',tag_suffix = ')',
  caption = 'Copyright applies. Planet Labs')
ggsave("figs/main_figure_co_models_scene-subset-good-comparison-forest-edge.png",dpi=300, dev='png',  height=12, width=18,units="in")
```