---
title: "SE Bars Notebook - Tuoloumne EXT DEM PLUS Colorado "
...
rastlist <- list.files(path = "data/CODEMPLUSSRTMEXT/", pattern='.tif', all.files=TRUE, full.names=TRUE)
library(caret)
i=0
plo <- data.frame()
skip_to_next <- FALSE
...
write_csv(df_tuol,file='./data/CODEMPLUSSRTMEXT/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_codemplus-extSRTM.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
