---
title: "SE Bars Notebook - Gunnison REDO NORM DEM Redo "
...
rastlist <- list.files(path = "data/DEMNORMBASEREDO/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
plo <- data.frame()
...
write_csv(df_tuol,file='./data/DEMNORMBASEREDO/processed-data.csv')
...
print(p)
ggsave("figs/all_scenes_demnormbase-co-redo.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_OA.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_FA.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_DENSE.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_MEDIUM.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_SPARSE.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_UC.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_CE.csv')
```
...
write_csv(df_gunni,file='./data/DEMNORMBASEREDO/processed-data_ch_OPEN.csv')
```
