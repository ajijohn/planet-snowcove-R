...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_OA.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_FA.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_DENSE.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_MEDIUM.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_SPARSE.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_UC.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_CE.csv')
```
...
write_csv(df_gunni,file='./data/DEMplusCOPredictions/processed-data_ch_OPEN.csv')
```
