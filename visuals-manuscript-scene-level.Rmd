---
title: "R visual Notebook - Whole scene"
...
aoi_manu <- extent(whole_scene_planet_co)
```
...
ggsave("figs/main_figure_co_models_scene.png",dpi=300, dev='png',  height=8, width=8,units="in")
```