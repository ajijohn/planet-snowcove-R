...
print(pch)
ggsave("figs/all_scenes_chpointzeroeight.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
```{r }
library(tidyverse)
plotch_longer_df <- read_csv(file='./data/DEMplusCHPredictions/processed-datapointzeroeight.csv')
