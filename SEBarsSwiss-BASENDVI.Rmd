---
title: "SE Bars Notebook- Swiss BASE with NDVI"
...
rastlist <- list.files(path = "data/CHBASENDVI/", pattern='.tif', all.files=TRUE, full.names=TRUE)
 library(caret)
i=0
ploch <- data.frame()
...
write_csv(df_swiss,file='./data/CHBASENDVI/processed-data.csv')
...
print(pch)
ggsave("figs/all_scenes_ch-BASENDVI.png",dpi=300, dev='png',  height=8, width=10,units="in")
# Finished bar plot
...
```{r }
library(tidyverse)
plotch_longer_df <- read_csv(file='./data/CHBASENDVI/processed-data.csv')
