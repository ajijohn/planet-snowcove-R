...
raster::writeRaster(df,'data/newstudy.tiff',overwrite=TRUE)
```
...
raster::writeRaster(df_cd,'data/newstudywithcd.tiff',overwrite=TRUE)
```
...
raster::writeRaster(df_dce,'data/newstudywithdce.tiff',overwrite=TRUE)
```
