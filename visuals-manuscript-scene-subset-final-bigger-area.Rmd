---
title: "R visual Notebook - Whole scene but one final - good but all"
...
aoi_manu <- extent(c(-107.0828  , -107.0639 ,39.02021  ,39.0273  ))
```
...
ggsave("figs/main_figure_co_models_scene-subset-good-comparison.png",dpi=300, dev='png',  height=12, width=10,units="in")
```